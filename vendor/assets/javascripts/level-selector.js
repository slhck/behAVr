...
module.exports = {
  ...
  level_selector: template("<button data-level-selector-button>  Auto</button><ul>  <li><a href=\"#\" data-level-selector-select=\"-1\">Auto</a></li>  <% for (var i = (levels.length - 1); i >= 0; i--) { %>    <li><a href=\"#\" data-level-selector-select=\"<%= i %>\">      <%= levels[i].height %>p      <% if (levels[i].height >= 720) { %>        (HD)      <% } %>    </a></li>  <% }; %></ul>"),

  CSS: {

    level_selector: ".level_selector[data-level-selector]{float:right;margin-top:6px;position:relative}.level_selector[data-level-selector] button{background-color:transparent;color:#fff;font-family:Roboto,\"Open Sans\",Arial,sans-serif;-webkit-font-smoothing:antialiased;border:none;font-size:12px}.level_selector[data-level-selector] button:hover{color:#c9c9c9}.level_selector[data-level-selector] button.changing{-webkit-animation:pulse .5s infinite alternate}.level_selector[data-level-selector]>ul{list-style-type:none;position:absolute;bottom:25px;left:-22px;width:85px;border:1px solid #000;display:none;background-color:#e6e6e6}.level_selector[data-level-selector] li a{color:#444;padding:2px 10px;display:block;text-decoration:none;font-size:12px}.level_selector[data-level-selector] li:hover{background-color:#555;color:#fff}.level_selector[data-level-selector] li:hover a{color:#fff;text-decoration:none}@-webkit-keyframes pulse{0%{color:#fff}50%{color:#ff0101}100%{color:#B80000}}" }
};
  ...
  _createClass(LevelSelector, {
    ...
    init: {
      value: function init() {
        if (window.fakePlayer !== undefined) {
          window.fakePlayer.levelSelector = this;
        }
        this.levels = {};
    ...
    bindEvents: {
      value: function bindEvents() {
        ...
        if (this.isEnabled()) {
          ...
          Clappr.Mediator.on(this.getContainer().playback.cid + ":fragmentloaded", function () {
            return _this.onFragmentLoaded();
          });
          Clappr.Mediator.on(this.getContainer().playback.cid + ":levelchanged", function (isHD) {
    ...
    setLevel: {
      value: function setLevel(level) {
        var immediately = arguments[1] === undefined ? false : arguments[1];

        if (window.fakePlayer !== undefined) {
          window.fakePlayer.onLevelChanged(level, this.getCurrentLevel(), immediately);
        }
    ...
    updateText: {
      value: function updateText() {
        ...
        if (this.auto_level) {
          ...
          // display_text = Math.floor(this.levels[level].bitrate / 1000)
          // display_text += ' kbps'
          display_text = this.levels[level].height + "p";
        }
